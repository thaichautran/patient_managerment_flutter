...
final Map<Type, dynamic> modelDecoders = {
  ...
  List<RawData>: (data) =>
      List.from(data['data']).map((json) => RawData.fromJson(json)).toList(),
  //
  RawData: (data) => RawData.fromJson(data['data']),

  List<Patient>: (data) =>
      List.from(data['data']).map((json) => Patient.fromJson(json)).toList(),

  Patient: (data) => Patient.fromJson(data['data']),
};
